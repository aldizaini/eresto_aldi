...
class Admin extends CI_Controller {
	...
	public function changePassword()
	{
		...
		$this->form_validation->set_rules('password1', 'New Password', 'required|min_length[3]|matches[password2]');
		$this->form_validation->set_rules('password2', 'Confirm New Password', 'required|min_length[3]|matches[password2]');
